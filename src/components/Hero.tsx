const Hero = () => {
  return <section className="relative pt-32 pb-16 px-4 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5 overflow-hidden">
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-up relative z-10">
          <a href="#contact" className="px-8 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-300 w-full sm:w-auto hover:shadow-lg">
            Get Involved
          </a>
          <a href="#about" className="px-8 py-3 bg-white/80 backdrop-blur border border-gray-200 rounded-lg hover:bg-white transition-all duration-300 w-full sm:w-auto hover:shadow-lg">
            Learn More
          </a>
        </div>
      </div>
